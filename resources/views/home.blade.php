        ...
        <div class="row h-100 align-items-center justify-content-center">
            <div class="col-12 text-center">    
                <div class="row justify-content-center">
                    ...
                    <div id="SearchModule" class="col-12 mb-3 ">
                        ...
                        <div id="AdvancedFormGroup" class="collapse">
                            <label for="SearchInput" id="SearchLabel" class="gray float-left mb-3 ml-2 d-none" ">Inserisci parole chiave</label>
                            <div class=" form-group">
                                ...
                                <label class="gray float-left mb-3 ml-2" for="CategorySelector">Categorie</label>
                            </div>
                            <div class="form-group">
                                ...
                                <label class="gray float-left mb-3 ml-2" for="country">Luogo</label>
                            </div>
                        </div>
                    ...
                    <div class="col-12 text-center ">
                        ...
                        <button type="button" id="SearcgBtn" class="btn btn-primary btn-lg m-2 px-5">Cerca</button>
